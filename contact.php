...
<div class="container bg-grey mt-4 " style="min-height: 70vh;">
  ...
  <div class="row mt-4">
    <div class="col-sm-5">
      <p>vous allez recevoir un mail a tout moment</p>
      <p class="font-weight-bold"><span class="glyphicon glyphicon-map-marker"></span> formation dclic</p>
      <p class="font-weight-bold"><span class="glyphicon glyphicon-envelope"></span> goubamoussaa74@gmail.com</p>
    </div>
    ...
    <div class="col-sm-7">
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <textarea class="form-control" id="comments" name="comments" placeholder="votre message"
          rows="5"></textarea><br>
        <div class="row">
